#Setting up functions for processing observed values along a flowline and evaluating the perfect plastic model along a given bed
# 3 Aug edit: plasticmodel function will now take "obsHEIGHTfunction" rather than obsthickfunction as an input.  Want to return more accurate surface elevation (from unsmoothed bed)
...
#------------------------------
def plasticmodel(bedfunction, Bfunction, startpoint, hinit, endpoint, Npoints, obsheightfunction):
    """Arguments used:
    ...
    for x in horiz[1::]:
        ...
        B = Bfunction(bed, modelthick, None, None)
